...
/**
 * Dedicated /register page for JLPT N2 Japanese Mastery Studio.
 *
 * Provides:
 *  - User Registration interface with username, password, and confirm password.
 *  - Floating bilingual language switcher (ID / EN) and dark mode toggle.
 *  - Automatically logs in and forwards to `/dashboard` upon successful account creation.
 *
